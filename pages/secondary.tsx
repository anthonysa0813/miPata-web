...
import styles from "../styles/secondary/Secondary.module.scss";
  ...
  return (
    <div className={styles.gridContainer}>
        ...
        <div className={styles.hero}>
          ...
          <div className={styles.text}>
            <p>
              ...
              encuentra los mejores <span> lugares pet friendly</span> y mucho
              más.
            </p>
      ...
      <div className={styles.services}>
        <div className={styles.imageContainer}>
          <h3>¡Nuestra aplicación móvil tiene todo lo que necesitas!</h3>
              ...
              >
                ...
                <div className={styles.infoServices}>
                  ...
                  <p>
                    ...
                    <span>
                      salud, baños, vacunas, alimentación, eventos y muchos tips
                      más.
                    </span>
                  </p>
                </div>
